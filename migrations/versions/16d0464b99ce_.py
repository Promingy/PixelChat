...
Revision ID: 16d0464b99ce
Revises:
Create Date: 2024-02-21 09:48:37.292303
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('server_id', sa.Integer(), nullable=True),
    sa.Column('owner_1_id', sa.Integer(), nullable=True),
    sa.Column('owner_2_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['owner_1_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['owner_2_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['server_id'], ['servers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    if environment == "production":
        op.execute(f"ALTER TABLE direct_rooms SET SCHEMA {SCHEMA};")
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('direct_room_id', sa.Integer(), nullable=True),
    sa.Column('body', sa.String(), nullable=True),
    sa.Column('pinned', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['direct_room_id'], ['direct_rooms.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    if environment == "production":
    ...
    op.create_table('direct_reactions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE direct_reactions SET SCHEMA {SCHEMA};")
...
def downgrade():
    ...
    op.drop_table('direct_reactions')
