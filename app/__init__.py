...
from .api.channel_routes import channel
...
app.register_blueprint(channel, url_prefix='/api/channels')
...
app.register_blueprint(direct_room, url_prefix='/api/direct_room')
app.register_blueprint(direct_message, url_prefix='/api/direct_message')
app.register_blueprint(direct_reaction, url_prefix='/api/direct_reaction')
db.init_app(app)
Migrate(app, db)
